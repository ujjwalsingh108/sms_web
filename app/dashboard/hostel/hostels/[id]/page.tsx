...
export default async function HostelDetailsPage({
  ...
  const getHostelTypeBadge = (type: string) => {
    switch (type) {
      case "boys":
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Badge
                className={`${getHostelTypeBadge(hostelData.hostel_type)} mt-2`}
              >
                {hostelData.hostel_type.charAt(0).toUpperCase() +
                  hostelData.hostel_type.slice(1)}{" "}
                Hostel
              </Badge>
            </div>
          </div>
          <Link href={`/dashboard/hostel/hostels/${params.id}/edit`}>
        ...
        <Card className="glass-effect border-0 shadow-xl">
          <CardHeader
            className={`border-b border-gray-200 dark:border-gray-700 pb-4 bg-gradient-to-r ${getHostelTypeColor(
        ...
        <Card className="glass-effect border-0 shadow-xl">
          <CardHeader className="border-b border-gray-200 dark:border-gray-700 pb-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link href={`/dashboard/hostel/rooms/new?hostel_id=${params.id}`}>
          ...
          <CardContent className="p-6">
            {rooms && rooms.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <Link
                  href={`/dashboard/hostel/rooms/new?hostel_id=${params.id}`}
                >
