  ...
  return (
    <div className="space-y-6 p-4 md:p-6 max-w-4xl mx-auto">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">
                  {txn.account_head.name}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Type:{" "}
                  {txn.account_head.type.charAt(0).toUpperCase() +
                    txn.account_head.type.slice(1)}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100 capitalize">
                  {txn.payment_method || "Not specified"}
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          href={`/dashboard/accounts/transactions/${txn.id}/edit`}
          className="w-full sm:w-auto"
        >
          <Button className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:opacity-90 shadow-lg">
            Edit Transaction
          </Button>
        </Link>
