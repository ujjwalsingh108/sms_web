...
import { getSectionById, getClasses } from "@/app/dashboard/academic/actions";
import { EditSectionForm } from "@/components/academic/edit-section-form";
...
export default async function EditSectionPage({
  ...
  const [sectionResult, classesResult] = await Promise.all([
    getSectionById(id),
    getClasses(),
  ]);
  ...
  const sectionData = (sectionResult as any).data;
