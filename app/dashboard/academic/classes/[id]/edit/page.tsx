...
import { getClassById } from "@/app/dashboard/academic/actions";
import { EditClassForm } from "@/components/academic/edit-class-form";
...
export default async function EditClassPage({
  ...
  const classData = (result as any).data;
